      ...
      <div class="modal-body"> <form method="POST" action="billout.php">
        <div style="width: 77%;margin: auto;">
          ...
          <div class="form-group">
            ...
            <input type="text" name="contact" class="form-control" id="some" required="true" maxlength="10" pattern="[0-9 ]+" >
          </div>
           <div class="form-group">
            <label for="some" class="col-form-label">Discount</label>
            <input type="number" name="discount" value="0" min="1" class="form-control" id="some" required>
          </div>
